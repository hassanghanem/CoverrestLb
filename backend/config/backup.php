...
return [
    ...
    'backup' => [
         ...
         * For Windows without gzip, set to null and rely on ZIP compression instead.
         */
        'database_dump_compressor' => null, // Disabled for Windows compatibility
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('APP_NAME', 'laravel') . '_backup_',
